...
func NewStaticAgent(node_id RoadNodeID, agent_type StaticAgentType, agent_prop map[string]any, vehicle_log_channel chan LoggerVehicleEvent) (StaticAgent, error) {
	switch agent_type {
	case IntersectionAgentType:
		return NewIntersectionAgent(node_id, &IntersectionAgentParams{}, vehicle_log_channel), nil
	case SpawnerAgentType:
		...
		return NewSpawnerAgent(node_id, &SpawnerAgentParams{spawn_rate: spawn_rate, lastSpawnTime: 0}, vehicle_log_channel), nil
	case SinkAgentType:
		return NewSinkAgent(node_id, &SinkAgentParams{}, vehicle_log_channel), nil
	case TrafficLightIntersectionAgentType:
		...
		return NewTrafficLightIntersectionAgent(node_id, &TrafficLightIntersectionAgentParams{time_intervals: time_intervals, time_interval_index: 0, time_interval_lastChange: 0}, vehicle_log_channel), nil
	default:
...
func NewIntersectionAgent(node_id RoadNodeID, params *IntersectionAgentParams, vehicle_log_channel chan LoggerVehicleEvent) *IntersectionAgent {
	return &IntersectionAgent{road_node_id: node_id, vehicles_processed: 0, vehicle_log_channel: vehicle_log_channel, params: params}
}
...
func NewSpawnerAgent(node_id RoadNodeID, params *SpawnerAgentParams, vehicle_log_channel chan LoggerVehicleEvent) *SpawnerAgent {
	return &SpawnerAgent{road_node_id: node_id, vehicles_processed: 0, vehicle_log_channel: vehicle_log_channel, params: params}
}
...
func NewSinkAgent(node_id RoadNodeID, params *SinkAgentParams, vehicle_log_channel chan LoggerVehicleEvent) *SinkAgent {
	return &SinkAgent{road_node_id: node_id, vehicles_processed: 0, vehicle_log_channel: vehicle_log_channel, params: params}
}
...
func NewTrafficLightIntersectionAgent(node_id RoadNodeID, params *TrafficLightIntersectionAgentParams, vehicle_log_channel chan LoggerVehicleEvent) *TrafficLightIntersectionAgent {
	return &TrafficLightIntersectionAgent{road_node_id: node_id, vehicles_processed: 0, vehicle_log_channel: vehicle_log_channel, params: params}
}
